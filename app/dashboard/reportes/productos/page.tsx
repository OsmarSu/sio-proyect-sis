...
import React, { useState, useEffect, Suspense } from 'react'; // Importar useState, useEffect y Suspense
                ...
                {reportData.stockActual.map((producto: any, index: number) => (
                  <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-center">
                      <span className={`px-3 py-1 rounded-full text-sm font-semibold ${producto.stockActual < producto.minStock ? 'bg-oasis-danger-light text-oasis-danger' : 'bg-oasis-success-light text-oasis-success'
                        }`}>
